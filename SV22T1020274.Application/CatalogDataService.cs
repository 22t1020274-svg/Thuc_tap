...
/// <summary>
/// Use case: danh mục hàng hóa (Category, Product, ProductAttribute, ProductPhoto).
/// </summary>
public static class CatalogDataService
{
    ...
    public static void Configure(IGenericRepository<Category> categoryRepository, IProductRepository productRepository)
    {
