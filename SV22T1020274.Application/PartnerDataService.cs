...
/// <summary>
/// Use case: đối tác (Supplier, Customer, Shipper).
/// </summary>
public static class PartnerDataService
{
    private static ISupplierRepository supplierDB = null!;
    ...
    public static void Configure(
        ...
        IGenericRepository<Shipper> shipperRepository)
    {
        supplierDB = supplierRepository;
        customerDB = customerRepository;
        shipperDB = shipperRepository;
    }
